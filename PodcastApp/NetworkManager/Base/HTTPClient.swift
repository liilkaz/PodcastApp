...
protocol PodcastClient {
    ...
    func sendRequestByTitle<T: Decodable>(endpoint: PodcastEndpoint, responseModel: T.Type, title: String) async -> Result<T, RequestError>
...
extension PodcastClient {
    ...
    func sendRequestByTitle<T: Decodable>(endpoint: PodcastEndpoint, responseModel: T.Type, title: String) async -> Result<T, RequestError> {
        ...
        urlComponents.host = endpoint.host
        urlComponents.path = endpoint.path
        urlComponents.queryItems = [URLQueryItem(name: "q", value: title), URLQueryItem(name: "pretty", value: nil)]
