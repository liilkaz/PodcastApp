...
//    private var dataSource: UICollectionViewDiffableDataSource<Section, PodcastModel>?
//    
//    //MARK: - UI Elements
//    
...
//    //MARK: - Registration
//    
//    private func registrFavorites() -> UICollectionView.CellRegistration<FavoritesListCell, PodcastModel> {
//        return UICollectionView.CellRegistration<FavoritesListCell, PodcastModel> { [weak self] (cell, indexPath, item) in
...
//    }
//    
//    private func registrPlaylist() -> UICollectionView.CellRegistration<FavoritsCell, PodcastModel> {
//        return UICollectionView.CellRegistration<FavoritsCell, PodcastModel> { [weak self] (cell, indexPath, label) in
...
//        
//        dataSource = UICollectionViewDiffableDataSource<Section, PodcastModel>(collectionView: collectionView) {
...
//        
//        var snapshot = NSDiffableDataSourceSnapshot<Section, PodcastModel>()
