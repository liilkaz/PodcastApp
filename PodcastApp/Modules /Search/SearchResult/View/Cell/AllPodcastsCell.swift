...
class AllPodcastsCell: UITableViewCell {
    ...
    private lazy var durationLabel = UILabel(text: "56:38", font: .manrope12regular(), textColor: .darkGray, textAlignment: .left)
    private lazy var episodeLabel = UILabel(text: "56 Eps", font: .manrope12regular(), textColor: .darkGray, textAlignment: .left)
