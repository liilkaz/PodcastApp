...
final class ProfileSettingViewController: UIViewController {
    ...
    private lazy var settingsTableView: UITableView = {
        ...
        tableView.register(ProfileSettingViewControllerTableViewCell.self, forCellReuseIdentifier: ProfileSettingViewControllerTableViewCell.identifier)
...
extension ProfileSettingViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: ProfileSettingViewControllerTableViewCell.identifier, for: indexPath) as? ProfileSettingViewControllerTableViewCell  else { return UITableViewCell() }
